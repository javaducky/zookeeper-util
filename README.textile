...
Recursively copies data from the source server into the same path on the target server starting from the provided path.

bc. zkutil clone -h
Usage: zk_clone.rb [options] -s <host:port> -t <host:port>
    -s, --source_connectstring host:port    Server info for clone source
    -t, --target_connectstring host:port    Server info for clone target
    -p, --start_path path                   Path to clone, defaults to '/'
    -v, --verbose                           Output more information
    -h, --help                              Display this screen
